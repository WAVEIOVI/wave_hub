...
const localEquipmentData = ref((props.equipmentSingleData))
...
const fetchProtectionData = () => {
  ...
  equipmentParamsStore.fetchProtection(selectedProtection.value)
    .then(response => {
      ...
      equipmentSingleData.value.equipment_protection_id = protectionData.value.protection_id
      equipmentSingleData.value.equipment_protection = protectionData.value.name
...
const onFormSubmit = () => {
  emit('update:isDialogVisible', false)
  emit('submit', { equipmentSingleData: localEquipmentData.value, accessories: selectedAccessories.value })
}

watch(() => props.equipmentSingleData, newData => {
...
<template>
  ...
  >
    ...
    <VCard class="create-app-dialog">
      <VCardText
        v-if="!isEmpty(localEquipmentData)"
        class="pa-5 pa-sm-10"
      >
          ...
          >
            ...
            <table class="text-base">
              ...
              <tr>
                ...
                <td>
                  <p class="mb-2">
                    {{ localEquipmentData.equipment_pressure }}
                  </p>
                </td>
              </tr>
            </table>
      ...
      >
        <div class="misc-wrapper">
          <ErrorHeader
            error-title="Equipment Not Found :("
            error-description="We couldn't find the equipment you are looking for."
          />
        </div>
      </VCardText>
    </VCard>
