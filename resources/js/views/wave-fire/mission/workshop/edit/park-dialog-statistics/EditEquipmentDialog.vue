...
const localWorkshopData = ref((props.interventionData))
                  ...
                  <VRow>
                    <VCol cols="12">
                      <VCard>
                        <VCardItem>
                          <h4 class="mt-4 mb-0">
                            {{ localEquipmentData.equipment_category }} {{ localEquipmentData.equipment_model }} {{ localEquipmentData.equipment_weight }} {{ localEquipmentData.equipment_pressure }}
                          </h4>
